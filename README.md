This file is the baseline code for Google Smartphone Decimeter Challenge--Improve high precision GNSS positioning and navigation accuracy on smartphones

以上文件是Google Smartphone Decimeter Challenge--Improve high precision GNSS positioning and navigation accuracy on smartphones（谷歌手机定位大赛）比赛的baseline代码
